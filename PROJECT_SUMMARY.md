...
| 優先級 | 系統 | 狀態 | 說明 |
|--------|------|------|------|
| 高 | 英雄/將領系統 | ✅ 已設計 | 詳見 `ADDITIONAL_SYSTEMS.md` |
| 高 | 科技樹 | ✅ 已設計 | 個人科技 + 國家科技 |
| 中 | ~~聯盟/公會系統~~ | ❌ 已取消 | 使用國家系統替代 |
| 中 | 任務系統 | ✅ 已設計 | 主線 + 每日 + 成就 |
| 中 | 聊天系統 | ✅ 已設計 | 世界/國家/私聊頻道 |
| 低 | 商城系統 | ⏳ 待設計 | 道具、付費項目 |
| 低 | 排行榜 | ⏳ 待設計 | 戰力、殺敵、貢獻 |
...
| `ADDITIONAL_SYSTEMS.md` | 將領/科技/任務/聊天系統 | v1.0 |
| `PROJECT_SUMMARY.md` | 本文件 - 完整設計摘要 | v1.1 |
...
### F. 為什麼領地格數從 20 改為 15?
- 原設計: 基礎 20 格，科技可增加到 25 格
- 修正後: 基礎 15 格，科技可增加到 20 格
- 原因: 增加建築格位的策略性，玩家需要更謹慎規劃
